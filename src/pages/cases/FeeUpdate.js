...
import { faCalendarAlt, faMoneyBillWave, faClipboard, faSave, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
const FeeUpdate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { error: updateFeeError } = await supabase.from('fee_details').update({
        case_id: caseId,
        date: newFee.date,
