          ...
          <div className={styles.cardsGrid}>
            ...
            >
              ...
              <div className={styles.cardBody}>
                <p className={styles.cardDescription}>{t('ApprenticeDetailsDescription')}</p>
                <div className={styles.statsRow}>
                  <div className={styles.statBlock}>
                    <span className={styles.statLabel}>{t('TotalApprentices')}</span>
            ...
            >
              ...
              <div className={styles.cardBody}>
                <p className={styles.cardDescription}>{t('AttorneyDetailsDescription')}</p>
                <div className={styles.statsRow}>
                  <div className={styles.statBlock}>
                    <span className={styles.statLabel}>{t('TotalAttorneys')}</span>
